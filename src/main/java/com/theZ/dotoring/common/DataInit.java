...
//
//            SaveMentiRqDTO saveMentiRqDTO = new SaveMentiRqDTO("전남대학교",3L,majorsList,fieldList,null,"도토링증","안녕하세요 전남대학교 3학년 도토링증입니다.","dotoring92",bCryptPasswordEncoder.encode("dotoring92@@"), "dotoring92@naver.com");
//
...
//
//
//            MemberAccount memberAccount2 = new MemberAccount("gotoring52", bCryptPasswordEncoder.encode("gotoring52@@"), "gotoring52@naver.com", saveCertificates2, MemberType.MENTI, MemberRole.ROLE_MENTI);
...
//
//            SaveMentiRqDTO saveMentiRqDTO2 = new SaveMentiRqDTO("전남대학교",3L,majorsList2,fieldList2,null,"도와줘증","안녕하세요 전남대학교 3학년 도와줘증입니다.","gotoring52",bCryptPasswordEncoder.encode("gotoring52@@"), "gotoring52@naver.com");
//
...
//
//
//            MemberAccount memberAccount3 = new MemberAccount("dkkoring62", bCryptPasswordEncoder.encode("dkkoring62@@"), "dkkoring62@naver.com", saveCertificates3, MemberType.MENTI, MemberRole.ROLE_MENTI);
...
//
//            SaveMentiRqDTO saveMentiRqDTO3 = new SaveMentiRqDTO("전남대학교",3L,majorsList3,fieldList3,null,"도레미증","안녕하세요 전남대학교 3학년 도레미증입니다.","dkkoring62",bCryptPasswordEncoder.encode("dkkoring62@@"), "dkkoring62@naver.com");
//
...
//
//
//            MemberAccount memberAccount4 = new MemberAccount("dotojjng82", bCryptPasswordEncoder.encode("dotojjng82@@"), "dotojjng82@naver.com", saveCertificates4, MemberType.MENTI, MemberRole.ROLE_MENTI);
...
//
//            SaveMentiRqDTO saveMentiRqDTO4 = new SaveMentiRqDTO("전남대학교",4L,majorsList4,fieldList4,null,"막내아들증","안녕하세요 전남대학교 4학년 막내아들증입니다.","dotojjng82",bCryptPasswordEncoder.encode("dotojjng82@@"), "dotojjng82@naver.com");
//
...
//             */
//            Certificate certificate = new Certificate("원본 증명서이름입니다.", "저장시 사용될 dotori증증명서이름입니다.");
//            List<Certificate> certificates = List.of(certificate);
//            List<Certificate> saveCertificates = certificateRepository.saveAll(certificates);
//
//            MemberAccount memberAccount = new MemberAccount("sonny12385", bCryptPasswordEncoder.encode("sonny12385@@"), "sonny12385@naver.com", saveCertificates, MemberType.MENTO, MemberRole.ROLE_MENTO);
//            memberAccountRepository.save(memberAccount);
//
//            List<String> fieldList = List.of("진로", "개발_언어", "공모전");
//            List<com.theZ.dotoring.app.field.model.Field> fields = fieldList.stream().map(com.theZ.dotoring.app.field.model.Field::new).collect(Collectors.toList());
...
//            List<MemberMajor> memberMajorList = memberMajorRepository.saveAll(memberMajors);
//
//            SaveMentoRqDTO mentoSignupRequestDTO = new SaveMentoRqDTO("전남대학교",3L,fieldList,majorsList,null,"황대선증","안녕하세요 전남대학교 3학년 황대선증입니다!","sonny12385", bCryptPasswordEncoder.encode("sonny12385@@"), "sonny12385@naver.com");
//
...
//             */
//
//            Certificate certificate1 = new Certificate("원본 증명서이름입니다.", "저장시 사용될 장현지증 증명서이름입니다.");
...
//
//
//            MemberAccount memberAccount1 = new MemberAccount("hynji12349", bCryptPasswordEncoder.encode("hynji12349@@"), "hynji12349@naver.com", saveCertificates1, MemberType.MENTO, MemberRole.ROLE_MENTO);
...
//
//            SaveMentoRqDTO mentoSignupRequestDTO1 = new SaveMentoRqDTO("전남대학교",3L,fieldList1,majorsList1,null,"장현지증","안녕하세요 전남대학교 3학년 장현지증에요!!","hynji12349", bCryptPasswordEncoder.encode("hynji12349@@"), "hynji12349@naver.com");
//
...
//             */
//
//            Certificate certificate2 = new Certificate("원본 증명서이름입니다.", "저장시 사용될 이승건증 증명서이름입니다.");
//            List<Certificate> certificates2 = List.of(certificate2);
//            List<Certificate> saveCertificates2 = certificateRepository.saveAll(certificates2);
//
//
//            MemberAccount memberAccount2 = new MemberAccount("sksks12340", bCryptPasswordEncoder.encode("sksks12340@@"), "sksks12340@naver.com", saveCertificates2, MemberType.MENTO, MemberRole.ROLE_MENTO);
//            memberAccountRepository.save(memberAccount2);
//
//
...
//            List<MemberMajor> memberMajorList2 = memberMajorRepository.saveAll(memberMajors2);
//
//            SaveMentoRqDTO mentoSignupRequestDTO2 = new SaveMentoRqDTO("전남대학교",4L,fieldList2,majorsList2,null,"이승건증","안녕하세요 전남대학교 4학년 이승건증입니다!!","sksks12340", bCryptPasswordEncoder.encode("sksks12340@@"), "sksks12340@naver.com");
//
...
//             */
//
//            Certificate certificate3 = new Certificate("원본 증명서이름입니다.", "저장시 사용될 이시현증 증명서이름입니다.");
//            List<Certificate> certificates3 = List.of(certificate3);
//            List<Certificate> saveCertificates3 = certificateRepository.saveAll(certificates3);
//
//
//            MemberAccount memberAccount3 = new MemberAccount("smsms12340", bCryptPasswordEncoder.encode("smsms12340@@"), "smsms12340@naver.com", saveCertificates3, MemberType.MENTO, MemberRole.ROLE_MENTO);
//            memberAccountRepository.save(memberAccount3);
//
//
...
//            List<MemberMajor> memberMajorList3 = memberMajorRepository.saveAll(memberMajors3);
//
//            SaveMentoRqDTO mentoSignupRequestDTO3 = new SaveMentoRqDTO("전남대학교",4L,fieldList3,majorsList3,null,"이시현증","안녕하세요 전남대학교 3학년 이시현증입니다!!","smsms12340", bCryptPasswordEncoder.encode("smsms12340@@"), "smsms12340@naver.com");
//

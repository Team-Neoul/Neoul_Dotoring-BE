...
@Setter
@Builder
public class NotificationSaveResDTO {
    ...
    public static NotificationSaveResDTO of(Notification notification, String memberName, String memberMajor){
        return NotificationSaveResDTO.builder()

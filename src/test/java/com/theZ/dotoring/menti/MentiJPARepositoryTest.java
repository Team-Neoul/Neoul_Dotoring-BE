...
public class MentiJPARepositoryTest {
    ...
    public void setUp(){
        ...
        MentoSignupRequestDTO mentoSignupRequestDTO = new MentoSignupRequestDTO("전남대학교",3L,majorsList,fieldList,"도토링","안녕하세요 전남대학교 3학년 도토링입니다.","dotoring12","dotoring12@@", "dotoring12@naver.com");
